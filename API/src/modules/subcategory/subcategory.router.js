...
// get subcategory  
subcategoryRouter.get('/:categoryId', isValid(getsubCategoryVal), asyncHandler(getSubcategory))  

// get specific subcategory
//subcategoryRouter.get('/:subcategoryId', asyncHandler(subcategoryById))
